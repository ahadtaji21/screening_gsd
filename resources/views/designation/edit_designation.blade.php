    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card card-warning card-outline">
                <form id="EditDesignation" action="{{url("/update_designation/".$designation->id)}}" method="post">
                    @csrf
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-pencil-ruler"></i> Edit Job Title Form</h3>
                        ...
                        <div style="float: right;">
                            ...
                            <div class="btn-group">
                                <button type="submit" class="btn btn-info bg-gradient-success" data-toggle="tooltip" data-placement="bottom" title="Save Records">
                                    <i class="fa fa-save"></i> Edit Designation</button>
                            </div>
                        </div>
                    </div>
                </form>
