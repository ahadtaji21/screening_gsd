...
<p class="textemail">This is to bring in your notice that, Employee has been marked as leaver and updated in GSD by {{$details['created_by']}}<br>
...
<table id="customers">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{$details['employee_status_date']}}</td>
        </tr>
    ...
    <tbody>
        ...
        <tr>
            <td><strong>Leaver Date</strong></td>
            <td><strong>{{$details['employee_status_date']}}</strong></td>
        </tr>
    </tbody>--}}
</table>
 <br><br>
