...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>User Email Mgt</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">User</a></li>
                        <li class="breadcrumb-item active">Email Mgt</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <div class="card card-info card-outline">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-users-cog"></i> User Email Mgt</h3>
                ...
                <div class="card-body">
                    <table id="UserGrid" class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            {{--<th>Department</th>--}}
                            <th>Region</th>
                            <th>Email Screening Add</th>
                            <th>Email Screening Status</th>
                            <th>Email Screening Comment</th>
                            <th>Leaver Email</th>
                            {{--<th>Role</th>--}}
                        ...
                        @forelse($users as $u)
                            <tr id="tr_{{$u->id}}">
                                ...
                                {{--<td>
                                @foreach ($u->fieldOfficeIds as $Key_field_office_id => $val_field_office_id)
                                    {{ $fieldOfficeIds[$Key_field_office_id]->name }}
                                @endforeach
                                </td>--}}
                                <td class="project-state">
                                    @if($u->screening_add_email == 'on')
                                ...
                                <td class="project-state">
                                    @if($u->screening_status_email == 'on')
                                        <span class="badge badge-success">ON</span>
                                    @else
                                        <span class="badge badge-danger">OFF</span>
                                    @endif
                                ...
                                <td class="project-state">
                                    @if($u->screening_comment_email == 'on')
                                        <span class="badge badge-success">ON</span>
                                    @else
                                        <span class="badge badge-danger">OFF</span>
                                    @endif
